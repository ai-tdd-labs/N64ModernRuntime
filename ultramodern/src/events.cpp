        ...
        if (ultramodern::is_game_started()) {
            ...
            if (remaining_retraces == 0) {
                if (cur_state->mq != NULLPTR) {
                    ...
                    ultramodern::enqueue_external_message(cur_state->mq, cur_state->msg, false, false, "vi");
                }
            ...
            if (events_context.ai.mq != NULLPTR) {
                ...
                ultramodern::enqueue_external_message(events_context.ai.mq, events_context.ai.msg, false, false, "ai");
            }
        }
...
void ultramodern::send_si_message() {
    ultramodern::enqueue_external_message(events_context.si.mq, events_context.si.msg, false, true, "si");
}
